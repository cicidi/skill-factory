# Document Index — skill-factory
> Last updated: 2026-07-26 05:57:05 UTC
...
| ✅ | decision-history | [2026-07-22-skill-add-transcribe-audio--local-gpu-whisper-au-decision.md](decision-history/2026-07-22-skill-add-transcribe-audio--local-gpu-whisper-au-decision.md) | Decision Record — 2026-07-22 |
| ✅ | decision-history | [2026-07-23-skillluma-event-scout-add-robotics-reading-club-decision.md](decision-history/2026-07-23-skillluma-event-scout-add-robotics-reading-club-decision.md) | Decision Record — 2026-07-23 |
| ✅ | decision-history | [unknown-add-variant-thinking-high-to-the-build-agent--decision.md](decision-history/unknown-add-variant-thinking-high-to-the-build-agent--decision.md) | Decision Record — unknown |

### design

| St | Type | File | What It Contains |
|----|------|------|-----------------|
| ✅ | design | [skill-factory-design.md](design/skill-factory-design.md) | 好的，根据您提供的完整开发历史记录，我为您整理并撰写了《skill-factory Design》技术设计文档。 |

### impl-plan

| St | Type | File | What It Contains |
|----|------|------|-----------------|
| ✅ | impl-plan | [skill-factory-impl-plan.md](impl-plan/skill-factory-impl-plan.md) | skill-factory Implementation Plan |

### prd

| St | Type | File | What It Contains |
|----|------|------|-----------------|
| ✅ | prd | [skill-factory-prd.md](prd/skill-factory-prd.md) | Change Log |

### spec

| St | Type | File | What It Contains |
|----|------|------|-----------------|
| ✅ | spec | [skill-factory-spec.md](spec/skill-factory-spec.md) | skill-factory Technical Specification |
